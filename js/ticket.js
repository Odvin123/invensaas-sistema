document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("ticket-company").textContent =
    ticketData.nombreEmpresa || "TU EMPRESA";

  document.getElementById("ticket-folio").textContent =
    "#" + (ticketData.folio || "--");
  ...
  document.getElementById("ticket-cliente").textContent =
    ticketData.clienteNombre || "PUBLICO EN GENERAL";

  document.getElementById("ticket-vendedor").textContent =
    ticketData.vendedorNombre || "MOSTRADOR";

  document.getElementById("ticket-efectivo").textContent =
    "C$" + (ticketData.efectivo || ticketData.total || 0).toFixed(2);
  ...
  if (ticketData.productos && ticketData.productos.length > 0) {
    ...
    document.getElementById("ticket-subtotal").textContent =
      "C$" + subtotal.toFixed(2);
    document.getElementById("ticket-total").textContent =
      "C$" + (ticketData.total || subtotal).toFixed(2);
  } else {
    tbody.innerHTML = `
            <tr>
  ...
  document.getElementById("ticket-cambio").textContent =
    "C$" + (cambio >= 0 ? cambio.toFixed(2) : "0.00");
...
function downloadTicket() {
  ...
  doc.text("Sistema de Gestión de Inventario", pageWidth / 2, y, {
    align: "center",
  });
  y += 4;
  doc.setFontSize(16);
  ...
  doc.text(
    "C$" + (ticketData.efectivo || 0).toFixed(2),
    pageWidth - margin,
    y,
    { align: "right" },
  );
  ...
  doc.setTextColor("#6366f1");
  doc.text("InvenSaaS - Facturación Electrónica", pageWidth / 2, y, {
    align: "center",
  });
